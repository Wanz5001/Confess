...
<!-- Lagu We Fell in October -->
<audio id="song" src="your_audio_file_link_here.mp3"></audio>
...
<script>
    ...
    yesBtn.addEventListener('click', function() {
        song.play(); // Mainkan lagu We Fell in October
        stickers.style.display = "block"; // Paparkan stiker blushing
    });
</script>
